...
?>
  ...
  <div class="righttop1">
      ...
      <form action="search.php" method="POST">
        <input name="search" type="text" maxlength="20" class="textfield"  placeholder="search your friends"/>
...
?></a></li>
      <li><a href="Home.php">Home</a></li>
	    ...
	    <a href="Terms.html"><font size="2" class="font1">Terms/Condition</font></a>
        </li>
      </ul>
